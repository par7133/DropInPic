 ...
 *
 * This file is part of DropInPic.
 *
 * DropInPic is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * DropInPic is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
 * GNU General Public License for more details.  
 * 
 * You should have received a copy of the GNU General Public License
 * along with DropInPic. If not, see <https://www.gnu.org/licenses/>.
 *
 * index.php
 * 
 * DropInPic home page.
 ...
 function showHistory() {
   ...
   foreach($signHistoryCopy as $val) {
     ...
     if ($contextType === PERSONAL_CONTEXT_TYPE) {
       ...
       echo("<span class='data-title'><a href='#' h-ref='/open/?fn=".$oriFilename."' onclick=openPrev('/open/?fn=".$oriFilename."')>".$mytitle."</a></span>");
       echo("</td>");
 ...
 function upload() {
  ...
  if (!empty($_FILES['files']['tmp_name'][0]) ||  !empty($_FILES['filesdd']['tmp_name'][0])) {
     ...
     foreach($uploads as &$upload) {
       ...
       $destPath = APP_DATA_PATH . DIRECTORY_SEPARATOR . "picture"; 
...
<div id="content-bar">
  ...
  <div style="width:100%; padding: 8px; text-align:center; font-size:26px; border:0px solid red;">
    ...
    <div id="picprev" style="display:none;position:absolute;width:300px;height:300px;background-size:cover;background-repeat:no-repeat;">&nbsp;</div>
    ...
    <?php if (APP_DEFAULT_CONTEXT === "PRIVATE"): ?>
     ...
     <div id="content-header">
      ...
      <?php else: ?>
        ...
        <div id="template-img">
        <div id="templated">
        <a href="/template.jpg"><img src="/DIS_res/template.png"></a>
        </div>
        </div>
    ...
    <div id="footer2">
      <a id="ahome" href="http://dropinpic.5mode-foss.eu" target="_blank" style="color:black;"><img id="logo-hl" src="/DIS_res/DIlogo.png">Powered by DropInPic</a>
    </div>
    <?php endif; ?>&nbsp;
